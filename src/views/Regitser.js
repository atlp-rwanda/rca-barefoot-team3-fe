...
export default function Regitser() {
  ...
  const handleRegister = (formValue) => {
    const { firstname,lastname,gender,password,confirmPassowrd,username, email } = formValue;
...
<Formik
            ...
            <Form>
              {!successful && (
                <div>
                  ...
                  <button className='   my-2 w-full button-primary'>Sign Up</button>
                </div>
              )}
            </Form>
          )}
    ...
    <div className=' bg-black w-6/12'>
      <img className=" w-full object-fill" src="/images/signup.jpg" />
    </div>
    {message && (
        <div >
          <div
